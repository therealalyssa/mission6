        ...
        <Box Boxspacing={2}>
            ...
            <div className="listing-container-right">
                ...
                <div className="filters"
                    ...
                    <p>Filters</p>
                    <Button style={{ color: "#414750", background: "#FFFFFF", border: "1px solid #CFD4D9" }} variant="outlined">Medium (256GB-512GB)<ClearIcon /></Button>
                    <Button style={{ color: "#414750", background: "#FFFFFF", border: "1px solid #CFD4D9" }} variant="outlined">8 gigabytes<ClearIcon /></Button>
                    <p>Clear all</p>
                </div>
